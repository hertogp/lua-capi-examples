// file ex07.c
// gcc -Isrc -undefined -shared -fPIC -o ex07.so src/ex07.c
...
* - adding an iterator
*   for k, v in pairs(anOddlyEvenStore) do
*     print(itm)
*   end
*
*/
...
new (lua_State *L)
{
    ...
    luaL_getmetatable(L, "ex07.OddlyEven");
...
checkUserDatum (lua_State *L)
{
    ...
    void *ud = luaL_checkudata(L, 1, "ex07.OddlyEven");
...
//luaopen_<libname>
int luaopen_ex07 (lua_State *L)
{
    luaL_newmetatable(L, "ex07.OddlyEven");  // [ M ]
