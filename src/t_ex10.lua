...
print("for v in a:values() do print('>> value', v) end\n");
print("setting a[2]=forty-2, a[5]=forty-4 and iterate object a");
a[2] = "forty-2";
a[5] = "forty-4";
...
-- iterate OddlyEven  for k in a:keys() do .. end

print();
print("for-keys  ".. string.rep("-", 45));
print("for v in a:keys() do print('>> key' ,k) end\n");
for k in a:keys() do
  print(">> key", k)
end


print("\n\n\nend of code.  __gc will kick in from here\n");
